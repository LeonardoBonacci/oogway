...
rem start cmd.exe /k "cd spectre\geo\%geo% & java -jar target\%geo%-%version%.jar""
rem start cmd.exe /k "cd spectre\%localtimer% & java -jar target\%localtimer%-%version%.jar""
rem start cmd.exe /k "cd spectre\%sentiment% & java -jar target\%sentiment%-%version%.jar""
